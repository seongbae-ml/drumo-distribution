...
/**
 * @file
 * Contains \Drupal\drumo\Tests\DrumoTest.
 */

namespace Drupal\drumo\Tests;
...
/**
 * Tests Drumo installation profile expectations.
 *
 * @group drumo
 */
class DrumoTest extends WebTestBase {

  use SchemaCheckTestTrait;

  protected $profile = 'drumo';
  ...
  /**
   * Tests Drumo installation profile.
   */
  function testDrumo() {
    $this->drupalGet('');
    ...
    // drumo profile modules are enabled.
    ...
    // Ensure that configuration from the Drumo profile is not reused when
